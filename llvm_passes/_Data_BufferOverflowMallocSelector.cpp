...
namespace llfi{
    ...
    static RegisterFIInstSelector A( "BufferOverflowMalloc(Data)", new _Data_BufferOverflowMallocInstSelector());
    static RegisterFIRegSelector B("BufferOverflowMalloc(Data)", new FuncArgRegSelector(0));
}
