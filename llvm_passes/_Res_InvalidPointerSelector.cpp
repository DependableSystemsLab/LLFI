...
namespace llfi{
    class _Res_InvalidPointerInstSelector: public FIInstSelector{
        public:
            ...
            virtual void getCompileTimeInfo(std::map<std::string, std::string>& info){
                ...
                info["failure_mode"] = "InvalidPointer";
    ...
    static RegisterFIInstSelector A("InvalidPointer(Res)", new _Res_InvalidPointerInstSelector());
    static RegisterFIRegSelector B("InvalidPointer(Res)", new FuncDestRegSelector());
}