         ...
         if(isa<CallInst>(inst))
          ...
          CallInst* CI=dyn_cast<CallInst>(inst);
              Function* called_func=CI->getCalledFunction();
                 ...
                 {  std::cout<< " write or read Call was found"<<"\n";
...
static RegisterFIInstSelector X( "WrongSavedAddress(I/O)", new _IO_WrongSavedAddressInstSelector());
}
