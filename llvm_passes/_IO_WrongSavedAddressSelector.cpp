...
namespace llfi{
    class _IO_WrongSavedAddressInstSelector: public FIInstSelector{
        public:
            ...
            virtual void getCompileTimeInfo(std::map<std::string, std::string>& info){
                ...
                info["failure_mode"] = "WrongSavedAddress";
    ...
    static RegisterFIInstSelector A("WrongRetrievedAddress(I/O)", new _IO_WrongSavedAddressInstSelector());
    static RegisterFIRegSelector B("WrongRetrievedAddress(I/O)", new _IO_WrongSavedAddressRegSelector());
}
