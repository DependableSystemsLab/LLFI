...
namespace llfi{
    ...
    static RegisterFIInstSelector A("NoMessage(MPI)", new _MPI_NoMessageInstSelector());
    static RegisterFIRegSelector B("NoMessage(MPI)", new FuncArgRegSelector(1));
}