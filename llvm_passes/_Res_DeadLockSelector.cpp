...
namespace llfi{
    class _Res_DeadLockInstSelector: public FIInstSelector{
        public:
            ...
            virtual void getCompileTimeInfo(std::map<std::string, std::string>& info){
                ...
                info["injector"] = "PthreadDeadLockInjector";
            }
    ...
    static RegisterFIInstSelector A("DeadLock(Res)", new _Res_DeadLockInstSelector());
    static RegisterFIRegSelector B("DeadLock(Res)", new FuncArgRegSelector(0));
}