...
namespace llfi{
    class _Res_MemoryExhaustionInstSelector: public SoftwareFIInstSelector{
        public:
            _Res_MemoryExhaustionInstSelector(){
                funcNames.insert(std::string("malloc"));
                funcNames.insert(std::string("calloc"));
            }
            virtual void getCompileTimeInfo(std::map<std::string, std::string>& info){
                info["failure_class"] = "Resource";
                info["failure_mode"] = "MemoryExhaustion";
                ...
                info["injector"] = "MemoryExhaustionInjector";
            }
    ...
    static RegisterFIInstSelector A("MemoryExhaustion(Res)", new _Res_MemoryExhaustionInstSelector());
    static RegisterFIRegSelector B("MemoryExhaustion(Res)", new FuncDestRegSelector());
}