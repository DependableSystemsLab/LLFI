...
public class MyThread extends Thread
{
   ...
   public void run()
   {
	   ...
	   try{
		   ...
		   ProcessBuilder p = new ProcessBuilder("/bin/tcsh","-c",Controller.llfibuildPath+"bin/injectfault --GUI "+Controller.currentProgramFolder+"/llfi/"+Controller.currentProgramFolder+"-faultinjection.exe "+Controller.inputString);
		   Controller.console.add("$ "+Controller.llfibuildPath+"bin/injectfault --GUI "+Controller.currentProgramFolder+"/llfi/"+Controller.currentProgramFolder+"-faultinjection.exe"+Controller.inputString+"\n");
