; ModuleID = '/ubc/ece/home/am/grads/raiyat/project/LLFI/test_programs/API-F1/llfi/API-Call-llfi_index.ll'
...
entry:
  ...
  %fi = call i8* @injectFault0(i64 6, i8* getelementptr inbounds ([11 x i8]* @.str, i64 0, i64 0), i32 45, i32 0, i32 1)
  %1 = call %struct.FILE* @fopen(i8* noalias %fi, i8* noalias getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !llfi_index !6
...
bb1:                                              ; preds = %entry
  ...
  %5 = load %struct.FILE** %fp, align 8, !llfi_index !15
  %6 = call i32 @fgetc(%struct.FILE* %5) nounwind, !llfi_index !16
  %7 = trunc i32 %6 to i8, !llfi_index !17
  store i8 %7, i8* %ch, align 1, !llfi_index !18
  br label %bb3, !llfi_index !19

bb2:                                              ; preds = %bb3
  %8 = load i8* %ch, align 1, !llfi_index !20
  %9 = sext i8 %8 to i32, !llfi_index !21
  %10 = call i32 @putchar(i32 %9) nounwind, !llfi_index !22
  %11 = load %struct.FILE** %fp, align 8, !llfi_index !23
  %12 = call i32 @fgetc(%struct.FILE* %11) nounwind, !llfi_index !24
  %13 = trunc i32 %12 to i8, !llfi_index !25
  store i8 %13, i8* %ch, align 1, !llfi_index !26
  br label %bb3, !llfi_index !27

bb3:                                              ; preds = %bb2, %bb1
  %14 = load i8* %ch, align 1, !llfi_index !28
  %15 = icmp ne i8 %14, -1, !llfi_index !29
  br i1 %15, label %bb2, label %bb4, !llfi_index !30

bb4:                                              ; preds = %bb3
  %16 = load %struct.FILE** %fp, align 8, !llfi_index !31
  %17 = call i32 @fclose(%struct.FILE* %16) nounwind, !llfi_index !32
  store i32 0, i32* %0, align 4, !llfi_index !33
  %18 = load i32* %0, align 4, !llfi_index !34
  store i32 %18, i32* %retval, align 4, !llfi_index !35
  br label %return, !llfi_index !36

return:                                           ; preds = %bb4
  %retval5 = load i32* %retval, !llfi_index !37
  call void @postInjections()
  ret i32 %retval5, !llfi_index !38
}
