...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %fi = call i64 @injectFault0(i64 41, i64 %18, i32 45, i32 0, i32 1)
  %21 = call i64 @fread(i8* noalias %19, i64 1, i64 %fi, %struct.FILE* noalias %20) nounwind, !llfi_index !41
...
bb6:                                              ; preds = %bb5
  ...
  %fi1 = call i64 @injectFault0(i64 60, i64 %34, i32 45, i32 0, i32 1)
  %37 = call i64 @fwrite(i8* noalias %35, i64 1, i64 %fi1, %struct.FILE* noalias %36) nounwind, !llfi_index !60
