...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %21 = call i64 @fread(i8* noalias %19, i64 1, i64 %18, %struct.FILE* noalias %20) nounwind, !llfi_index !41
  ...
  %fi = call i8* @injectFault0(i64 48, i8* %26, i32 45, i32 0, i32 1)
  call void @llvm.memmove.p0i8.p0i8.i64(i8* %fi, i8* %27, i64 50, i32 1, i1 false), !llfi_index !48
