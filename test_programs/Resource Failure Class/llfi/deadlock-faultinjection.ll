...
entry:
  ...
  %fi = call i64 @injectFault0(i64 22, i64 %9, i32 45, i32 0, i32 1)
  %10 = call i32 @pthread_join(i64 %fi, i8** null) nounwind, !llfi_index !22
  %11 = load i64* %thread2, align 8, !llfi_index !23
  %fi1 = call i64 @injectFault0(i64 24, i64 %11, i32 45, i32 0, i32 1)
  %12 = call i32 @pthread_join(i64 %fi1, i8** null) nounwind, !llfi_index !24
