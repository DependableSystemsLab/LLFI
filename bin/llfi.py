...
def compileProg():
  ...
  #TODO -S needs to be an option
	...
	execlist2 = ['-o', proftracedfile, mem2reg2file]
	execlist.extend(compileOptions)
	execlist.extend(execlist2)
	execCompilation(execlist)

	execlist = [optbin, '-load', llfilib, "-faultinjectionpass",'-S']
	execlist2 = ['-o', finjfile, mem2reg2file]
	execlist.extend(compileOptions)
	execlist.extend(execlist2)
	execCompilation(execlist)

	execlist = [optbin, '-load', llfilib, '-instTrace', '-tout', 'goldTraceOutput', '-S']
	execlist2 = ['-o', proffile, proftracedfile]
	#execlist.extend(compileOptions)
	execlist.extend(execlist2)
	execCompilation(execlist)

	execlist = [optbin, '-load', llfilib, '-instTrace', '-tout', 'faultyTraceOutput', '-S']
	execlist2 = ['-o', fifile, finjfile]
	#execlist.extend(compileOptions)
	execlist.extend(execlist2)
	execCompilation(execlist)
